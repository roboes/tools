...
/* Step 2 - Test if "meta_id" column is unique (Non_unique = 0 and Key_name = Primary) */
SHOW INDEXES FROM wp_woocommerce_gzd_shipment_itemmeta WHERE Column_name='meta_id' AND NOT Non_unique;

SHOW INDEXES FROM wp_woocommerce_gzd_shipment_itemmeta_old WHERE Column_name='meta_id' AND NOT Non_unique;
...
JOIN wp_woocommerce_gzd_shipment_itemmeta_old AS old
