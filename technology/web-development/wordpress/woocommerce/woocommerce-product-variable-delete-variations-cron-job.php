            ...
            if ($product->is_type(type: 'variable')) {
                ...
                if (!empty($variations_to_delete)) {
                    if ($delete) {
                        ...
                        wc_delete_product_transients(post_id: $product_id_current);
                        ...
                        foreach ($variations_to_delete as $variation_item) {
                            ...
                            wc_delete_product_transients(post_id: $variation_item['variation_id']);

                            echo "Deleted variation - Product ID: {$variation_item['product_id_current']}, Product Name: {$variation_item['product_name']}, Variation ID: {$variation_item['variation_id']}, Variation Name: {$variation_item['variation_name']}, Attributes: " . wp_json_encode($variation_item['attributes']) . "\n";
                        }
                        ...
                        if ($product instanceof WC_Product_Variable) {
                            ...
                            WC_Product_Variable::sync(product: $product_id_current);
                            $product->save();
                        }
                        ...
                        foreach ($variations_to_delete as $variation_item) {
                            echo "Variation to be deleted - Product ID: {$variation_item['product_id_current']}, Product Name: {$variation_item['product_name']}, Variation ID: {$variation_item['variation_id']}, Variation Name: {$variation_item['variation_name']}, Attributes: " . wp_json_encode($variation_item['attributes']) . "\n";
                        }
                    }
                } else {
