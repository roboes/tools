...
winget install --exact --id=IDRIX.VeraCrypt # Encrypt a non-system partition / drive → Standard VeraCrypt Volume → Encrypt partition in place  # https://github.com/veracrypt/VeraCrypt/issues/778
